...
export const input = `Game 1: 1 blue, 2 green, 3 red; 7 red, 8 green; 1 green, 2 red, 1 blue; 2 green, 3 red, 1 blue; 8 green, 1 blue
  ...
  for (const game of games) {
    ...
    for (const set of sets) {
      ...
      for (const color of colors) {
        ...
        console.log(colorCount + ' ' + colorValue)
        if ( (colorValue === 'red' && colorCount > 12)
          || (colorValue === 'green' && colorCount > 13)
          || (colorValue === 'blue' && colorCount > 14)
        ) {
          invalid = true
          break
        } 
